...
# rvanderc,11.24.20,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def read_data_from_file(file_name, list_of_rows):
        ...
        file.close()
        return list_of_rows, 'Current Data'

    @staticmethod
    def add_data_to_list(task, priority, list_of_rows):
        row = {"Task": task, "Priority": priority}
        list_of_rows.append(row)
        return list_of_rows, 'Task Added'
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        return list_of_rows, 'Task Deleted'
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        file.close()
        return list_of_rows, 'Task Saved'
...
class IO:
    ...
    def input_new_task_and_priority():
        task = str(input("Please enter the task to add: ")).strip()
        priority = str(input("What is the priority of the task: ")).strip()
        return task, priority

    @staticmethod
    def input_task_to_remove():
        task = str(input("Please enter the task to delete: ")).strip()
        return task
